...
autoDub.init = function() {
  ...
  $("body").prepend("<div  style=\"position: absolute; z-index: 88888888888888888; width: 65px; height: 300px; left: 0; -webkit-border-top-right-radius: 1rem; -webkit-border-bottom-right-radius: 1rem; -moz-border-radius-topright: 1rem; -moz-border-radius-bottomright: 1rem; border-top-right-radius: 1rem; border-bottom-right-radius: 1rem; overflow: hidden; top: 177px; background-color: rgba(0,0,0,.7);\" id=\"adubWATCHLIST\"></div>");
